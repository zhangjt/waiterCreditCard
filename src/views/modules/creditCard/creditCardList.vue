...
<script>
  import AddOrUpdate from './creditCardList-add-or-update'
  export default {
    data () {
      return {
        dataForm: {
    ...
    methods: {
      ...
      getDataList (page) {
        ...
        this.$http({
          url: this.$http.adornUrl('/creditCard/getList'),
          method: 'post',
      ...
      passHandle () {
        ...
        this.$confirm('是否确定上架?', '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/creditCard/editStatus'),
            method: 'post',
      ...
      deleteHandle (id) {
        ...
        this.$confirm('是否确定删除?', '提示', {
          ...
          this.$http({
            url: this.$http.adornUrl('/creditCard/delete'),
            method: 'post',
